  ...
  data() {
      ...
      return {
        ...
        rules: {
          ...
          body: [{ required:true, validator: validateRequire }],
          category_id:  [{ required:true, validator: validateRequire }],
  ...
  methods: {
    ...
    fetchData(id) {
      getPostDetail(id).then(response => {
        ...
        this.postForm.body = response.body
    ...
    handleSave() {
      ...
      const data = {title: this.postForm.title, body:this.postForm.body, category_id: this.postForm.category_id }
